		...
		<div class="main">
			...
			<div class="active-form" id="auth">
				<div class="io">
					...
					<div class="forgot"><a href="#"><?=$words['forgot_passw'] ?></a><span>?</span></div>
			...
			<div>
				<p class="register-link"><a href="/register/"><?=$words['reg_link'] ?></a></p>
			</div>
			<div>
				<label class="onepay"><a href="#" class="art-button art22 btn-large"><?=$words['onepay_link'] ?></a></label>
			</div>
		</div>
	</div>
</body>
